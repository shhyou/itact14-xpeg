...
static int huff_cbp[65536][2];
static const int huff_cbp_init[][3] =
  { { 111_b16, 111_len, 60 }
  , { 1101_b16, 1101_len, 4 }
  , { 1100_b16, 1100_len, 8 }
  , { 1011_b16, 1011_len, 16 }
  , { 1010_b16, 1010_len, 32 }
  , { 10011_b16, 10011_len, 12 }
  , { 10010_b16, 10010_len, 48 }
  , { 10001_b16, 10001_len, 20 }
  , { 10000_b16, 10000_len, 40 }
  , { 01111_b16, 01111_len, 28 }
  , { 01110_b16, 01110_len, 44 }
  , { 01101_b16, 01101_len, 52 }
  , { 01100_b16, 01100_len, 56 }
  , { 01011_b16, 01011_len, 1 }
  , { 01010_b16, 01010_len, 61 }
  , { 01001_b16, 01001_len, 2 }
  , { 01000_b16, 01000_len, 62 }
  , { 001111_b16, 001111_len, 24 }
  , { 001110_b16, 001110_len, 36 }
  , { 001101_b16, 001101_len, 3 }
  , { 001100_b16, 001100_len, 63 }
  , { 0010111_b16, 0010111_len, 5 }
  , { 0010110_b16, 0010110_len, 9 }
  , { 0010101_b16, 0010101_len, 17 }
  , { 0010100_b16, 0010100_len, 33 }
  , { 0010011_b16, 0010011_len, 6 }
  , { 0010010_b16, 0010010_len, 10 }
  , { 0010001_b16, 0010001_len, 18 }
  , { 0010000_b16, 0010000_len, 34 }
  , { 00011111_b16, 00011111_len, 7 }
  , { 00011110_b16, 00011110_len, 11 }
  , { 00011101_b16, 00011101_len, 19 }
  , { 00011100_b16, 00011100_len, 35 }
  , { 00011011_b16, 00011011_len, 13 }
  , { 00011010_b16, 00011010_len, 49 }
  , { 00011001_b16, 00011001_len, 21 }
  , { 00011000_b16, 00011000_len, 41 }
  , { 00010111_b16, 00010111_len, 14 }
  , { 00010110_b16, 00010110_len, 50 }
  , { 00010101_b16, 00010101_len, 22 }
  , { 00010100_b16, 00010100_len, 42 }
  , { 00010011_b16, 00010011_len, 15 }
  , { 00010010_b16, 00010010_len, 51 }
  , { 00010001_b16, 00010001_len, 23 }
  , { 00010000_b16, 00010000_len, 43 }
  , { 00001111_b16, 00001111_len, 25 }
  , { 00001110_b16, 00001110_len, 37 }
  , { 00001101_b16, 00001101_len, 26 }
  , { 00001100_b16, 00001100_len, 38 }
  , { 00001011_b16, 00001011_len, 29 }
  , { 00001010_b16, 00001010_len, 45 }
  , { 00001001_b16, 00001001_len, 53 }
  , { 00001000_b16, 00001000_len, 57 }
  , { 00000111_b16, 00000111_len, 30 }
  , { 00000110_b16, 00000110_len, 46 }
  , { 00000101_b16, 00000101_len, 54 }
  , { 00000100_b16, 00000100_len, 58 }
  , { 000000111_b16, 000000111_len, 31 }
  , { 000000110_b16, 000000110_len, 47 }
  , { 000000101_b16, 000000101_len, 55 }
  , { 000000100_b16, 000000100_len, 59 }
  , { 000000011_b16, 000000011_len, 27 }
  , { 000000010_b16, 000000010_len, 39 } };

static void init_huff_cbp() {
  for (size_t k = 0; k != sizeof(huff_cbp_init)/sizeof(huff_cbp_init[0]); ++k) {
...
static int huff_motion_vec[65536][2];
static const int huff_motion_vec_init[][3] =
  { { 00000011001_b16, 00000011001_len, -16 }
  , { 00000011011_b16, 00000011011_len, -15 }
  , { 00000011101_b16, 00000011101_len, -14 }
  , { 00000011111_b16, 00000011111_len, -13 }
  , { 00000100001_b16, 00000100001_len, -12 }
  , { 00000100011_b16, 00000100011_len, -11 }
  , { 0000010011_b16, 0000010011_len, -10 }
  , { 0000010101_b16, 0000010101_len, -9 }
  , { 0000010111_b16, 0000010111_len, -8 }
  , { 00000111_b16, 00000111_len, -7 }
  , { 00001001_b16, 00001001_len, -6 }
  , { 00001011_b16, 00001011_len, -5 }
  , { 0000111_b16, 0000111_len, -4 }
  , { 00011_b16, 00011_len, -3 }
  , { 0011_b16, 0011_len, -2 }
  , { 011_b16, 011_len, -1 }
  , { 1_b16, 1_len, 0 }
  , { 010_b16, 010_len, 1 }
  , { 0010_b16, 0010_len, 2 }
  , { 00010_b16, 00010_len, 3 }
  , { 0000110_b16, 0000110_len, 4 }
  , { 00001010_b16, 00001010_len, 5 }
  , { 00001000_b16, 00001000_len, 6 }
  , { 00000110_b16, 00000110_len, 7 }
  , { 0000010110_b16, 0000010110_len, 8 }
  , { 0000010100_b16, 0000010100_len, 9 }
  , { 0000010010_b16, 0000010010_len, 10 }
  , { 00000100010_b16, 00000100010_len, 11 }
  , { 00000100000_b16, 00000100000_len, 12 }
  , { 00000011110_b16, 00000011110_len, 13 }
  , { 00000011100_b16, 00000011100_len, 14 }
  , { 00000011010_b16, 00000011010_len, 15 }
  , { 00000011000_b16, 00000011000_len, 16 } };

static void init_huff_motion_vec() {
  size_t init_size = sizeof(huff_motion_vec_init)/sizeof(huff_motion_vec_init[0]);
